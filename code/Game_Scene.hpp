...
#define GAME_SCENE_HEADER
    ...
    namespace example
    {
        ...
        private:
            ...
            static constexpr float trunks_speed = 90.f;        ///< Velocidad a la que se mueven ambos jugadores (en unideades virtuales por segundo).
            static constexpr float car_speed = 270.f;        ///< Velocidad a la que se mueven ambos jugadores (en unideades virtuales por segundo).


            static constexpr int trunkRows = 3;
            static constexpr int trunkColumns = 5;

            static constexpr int carRows = 3;
            static constexpr int carColumns = 4;
            static constexpr int frogLives = 3;
        ...
        private:
            ...
            std::vector<Sprite *>        trunks;
            std::vector<Sprite *>        cars;
